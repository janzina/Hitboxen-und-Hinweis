...
public enum PlantType {
    ...
    KARTOFFEL ("Kartoffel",  5, 30, Color.BURLYWOOD,   "🥔", 2, 0),
    KOHL      ("Kohl",      10, 40, Color.LIGHTGREEN,  "🌿", 3, 0),
    TOMATE    ("Tomate",    15, 35, Color.TOMATO,      "🍅", 4, 0),
    KUERBIS   ("Kürbis",    25, 60, Color.DARKORANGE,  "🎃", 8, 0),
